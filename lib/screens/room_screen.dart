...
class _RoomScreenState extends State<RoomScreen>
  ...
  String _categoryLabel(String raw) {
    const labels = {
      ...
      // Google Places — mutfak / yemek türleri
      'acai_shop':               'Açaí Dükkanı',
      'afghani_restaurant':      'Afgan Mutfağı',
      'african_restaurant':      'Afrika Mutfağı',
      'american_restaurant':     'Amerikan Mutfağı',
      'asian_restaurant':        'Asya Mutfağı',
      'bagel_shop':              'Simitçi',
      'bar_and_grill':           'Bar & Izgara',
      'barbecue_restaurant':     'Mangal / BBQ',
      'brazilian_restaurant':    'Brezilya Mutfağı',
      'breakfast_restaurant':    'Kahvaltı',
      'brunch_restaurant':       'Brunch',
      'buffet_restaurant':       'Açık Büfe',
      'butcher_shop':            'Kasap',
      'cafeteria':               'Kafeterya',
      'candy_store':             'Şekerci',
      'cat_cafe':                'Kedi Kafe',
      'chinese_restaurant':      'Çin Mutfağı',
      'chocolate_factory':       'Çikolatacı',
      'chocolate_shop':          'Çikolatacı',
      'coffee_shop':             'Kahve',
      'confectionery':           'Şekerleme',
      'deli':                    'Şarküteri',
      'dessert_restaurant':      'Tatlıcı',
      ...
      'fine_dining_restaurant':  'Şık Restoran',
      'food_court':              'Yemek Alanı',
      'french_restaurant':       'Fransız Mutfağı',
      'greek_restaurant':        'Yunan Mutfağı',
      'hamburger_restaurant':    'Burgerci',
      'ice_cream_shop':          'Dondurmacı',
      'indian_restaurant':       'Hint Mutfağı',
      'indonesian_restaurant':   'Endonezya Mutfağı',
      'italian_restaurant':      'İtalyan Mutfağı',
      'japanese_restaurant':     'Japon Mutfağı',
      'juice_shop':              'Meyve Suyu',
      'kebab_shop':              'Kebapçı',
      'korean_restaurant':       'Kore Mutfağı',
      'lebanese_restaurant':     'Lübnan Mutfağı',
      'mediterranean_restaurant':'Akdeniz Mutfağı',
      'mexican_restaurant':      'Meksika Mutfağı',
      'middle_eastern_restaurant':'Orta Doğu Mutfağı',
      'pizza_restaurant':        'Pizzacı',
      'ramen_restaurant':        'Ramen',
      'sandwich_shop':           'Sandviççi',
      'seafood_restaurant':      'Deniz Ürünleri',
      'spanish_restaurant':      'İspanyol Mutfağı',
      ...
      'vietnamese_restaurant':   'Vietnam Mutfağı',
      'wine_bar':                'Şarap Bar',
      'sports_bar':              'Spor Bar',
      'juice_bar':               'Meyve Suyu Bar',
    };
